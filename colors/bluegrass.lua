...
vim.api.nvim_set_hl(0, "Special", { fg = c.icon_cyan })
...
vim.api.nvim_set_hl(0, "FzfLuaTitleFlags", { link = "Comment" })
vim.api.nvim_set_hl(0, "FzfLuaBackdrop", { bg = c.bg_dim })
...
vim.api.nvim_set_hl(0, "FzfLuaPreviewTitle", { link = "Title" })
...
vim.api.nvim_set_hl(0, "FzfLuaSearch", { link = "Search" })
vim.api.nvim_set_hl(0, "FzfLuaScrollBorderEmpty", { link = "FloatBorder" })
vim.api.nvim_set_hl(0, "FzfLuaScrollBorderFull", { link = "FloatBorder" })
vim.api.nvim_set_hl(0, "FzfLuaScrollFloatEmpty", { link = "Pmenu" })
vim.api.nvim_set_hl(0, "FzfLuaScrollFloatFull", { link = "Pmenusel" })

-- header / paths / buffers
vim.api.nvim_set_hl(0, "FzfLuaHeaderBind", { fg = c.fg_hint })
vim.api.nvim_set_hl(0, "FzfLuaHeaderText", { fg = c.fg_info })
...
vim.api.nvim_set_hl(0, "FzfLuaBufId", { link = "Comment" })
vim.api.nvim_set_hl(0, "FzfLuaBufNr", { fg = c.fg_number })
vim.api.nvim_set_hl(0, "FzfLuaBufLineNr", { link = "Linenr" })
vim.api.nvim_set_hl(0, "FzfLuaBufFlagCur", { fg = c.fg_hint })
vim.api.nvim_set_hl(0, "FzfLuaBufFlagAlt", { link = "Comment" })
vim.api.nvim_set_hl(0, "FzfLuaTabTitle", { link = "Title" })
vim.api.nvim_set_hl(0, "FzfLuaTabMarker", { fg = c.fg_match, bold = true })
vim.api.nvim_set_hl(0, "FzfLuaDirIcon", { link = "Directory" })
vim.api.nvim_set_hl(0, "FzfLuaDirPart", { link = "Directory" })
vim.api.nvim_set_hl(0, "FzfLuaFilePart", { link = "Normal" })
vim.api.nvim_set_hl(0, "FzfLuaLivePrompt", { fg = c.fg_info })
vim.api.nvim_set_hl(0, "FzfLuaLiveSym", { fg = c.fg_match, bold = true })
vim.api.nvim_set_hl(0, "FzfLuaCmdEx", { link = "Normal" })
vim.api.nvim_set_hl(0, "FzfLuaCmdBuf", { link = "Normal" })
vim.api.nvim_set_hl(0, "FzfLuaCmdGlobal", { link = "Normal" })

-- fzf process colors (drive the fzf pane via --color)
vim.api.nvim_set_hl(0, "FzfLuaFzfNormal", { link = "Normal" })
vim.api.nvim_set_hl(0, "FzfLuaFzfCursorLine", { link = "Cursorline" })
vim.api.nvim_set_hl(0, "FzfLuaFzfMatch", { fg = c.fg_match, bold = true })
vim.api.nvim_set_hl(0, "FzfLuaFzfBorder", { link = "FloatBorder" })
vim.api.nvim_set_hl(0, "FzfLuaFzfScrollbar", { link = "FloatBorder" })
vim.api.nvim_set_hl(0, "FzfLuaFzfSeparator", { link = "FloatBorder" })
vim.api.nvim_set_hl(0, "FzfLuaFzfGutter", { bg = c.bg })
vim.api.nvim_set_hl(0, "FzfLuaFzfHeader", { fg = c.fg_info })
vim.api.nvim_set_hl(0, "FzfLuaFzfInfo", { link = "Comment" })
vim.api.nvim_set_hl(0, "FzfLuaFzfPointer", { fg = c.fg_match })
vim.api.nvim_set_hl(0, "FzfLuaFzfMarker", { fg = c.fg_match })
vim.api.nvim_set_hl(0, "FzfLuaFzfSpinner", { fg = c.fg_warn })
vim.api.nvim_set_hl(0, "FzfLuaFzfPrompt", { fg = c.fg_hint })
vim.api.nvim_set_hl(0, "FzfLuaFzfQuery", { link = "Normal" })
